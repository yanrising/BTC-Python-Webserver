...
#G = bytes.fromhex('04b24b327404f5af4d5ff121a8184a0c71c0fc11292038c4335e10368cd313db910ca73f746d129106e71e5f60442f89ebd9725a632610ff1dafd7d8965a5ed841')
#Point_Coefficient = 106073574360006899076078361851851748805722414972168853555508929306449953097857
#*****************Bitcoin Domain Parameters***********************************************************************************************************************
#*****************************************************************************************************************************************************************
#There are two numbers(lambda1(N1) and lambda2(n-lambda-1))(N2) when multiplied with any point on curve-secp256k1 , return two other points on curve with exact same y-coordinate
#consider K to be any point on curve , there are two fixed numbers N1 and N2 such that: K*N1=C1  K*N2=C2 => y(K) = y(C1) = y(C2)
...
#*****************************************************************************************************************************************************************
##################Z/NZ(+,*)_Operations_isomorphic_to_abelian_points_group##############################################################################################
...
class WebServer(BaseHTTPRequestHandler):
    ...
    #unique Y coords : 38597363079105398474523661669562635950945854759691634794201721047172720498112(points have three different X-coordinates with the same Y-coordinate)
...
#-------------------------------------------------------------------------------------------------AJAX Fetch Page PART---------------------------------------
        ...
        if str_url.startswith("!"): # handle ajax request to get all data for modal popup window
            ...
            addrC_one = ice.privatekey_to_address(0, True, (numb)) #Compressed
            addrU_one = ice.privatekey_to_address(0, False, (numb))  #Uncompressed
            addrP2sh_one = ice.privatekey_to_address(1, True, (numb)) #p2sh
            addrbech32_one = ice.privatekey_to_address(2, True, (numb)) #bech32
            a1 = list()
            b_word1 = "No"
            a1.append(addrC_one)
            a1.append(addrU_one)
            ...
            addrP2sh_inv = ice.privatekey_to_address(1, True, (add_inv)) #p2sh
            addrbech32_inv = ice.privatekey_to_address(2, True, (add_inv)) #bech32
            #addrETH = ice.privatekey_to_ETH_address(__class__.startPrivKey)
            a2 = list()
            b_word = "No"
            a2.append(addrC)
            a2.append(addrU)
...
#---------End for AJAX modal windows---------------------------------------------------------------------------------------------
            ...
            for i in range(128): #generating addresses and WIFS to show on page
                ...
                addrP2sh = ice.privatekey_to_address(1, True, dec) #p2sh
                addrbech32 = ice.privatekey_to_address(2, True, dec) #bech32
                addrbech32_p2wsh = bitcoinlib.keys.Address(ice.point_to_cpub(ice.point_multiplication(startPrivKey,G)),encoding='bech32',script_type='p2wsh').address #bech32_p2swh
                #addrETH = ice.privatekey_to_ETH_address(__class__.startPrivKey)                 
...
<p id='same2addrpb' style='color:blue;background:#D7DBDD;padding:3px;font-weight:bold;font-size: 12px;'></p>
            ...
            self.wfile.write(bytes("<pre class='keys'><strong style='display:inline-block;width:450px;text-align:center;'>Private Key Hex</strong><strong style='display:inline-block;width:360px;text-align:center;'>WIF Private Key Uncompressed</strong><strong style='display:inline-block;width:242px;text-align:center;'>Legacy Uncompressed Address</strong><strong style='display:inline-block;width:242px;text-align:center;'>Legacy Compressed Address</strong><strong style='display:inline-block;width:244px;text-align:center;'>Segwit P2SH Address</strong><strong style='display:inline-block;width:298px;text-align:center;'>Bech32 P2WPKH Address</strong><strong style='display:inline-block;width:436px;text-align:center;'>Bech32 P2WSH Address</strong><strong style='display:inline-block;width:368px;text-align:center;'>WIF Private Key Compressed</strong><br>", "utf-8"))
            ###---Loop---******************************************************************
            for i in range(128): #generating addresses and WIFS to show on page
                ...
                addrP2sh = ice.privatekey_to_address(1, True, dec) #p2sh
                addrbech32 = ice.privatekey_to_address(2, True, dec) #bech32
                addrbech32_p2wsh = bitcoinlib.keys.Address(ice.point_to_cpub(ice.point_multiplication(__class__.startPrivKey,G)),encoding='bech32',script_type='p2wsh').address #bech32_p2wsh
                #addrETH = ice.privatekey_to_ETH_address(__class__.startPrivKey)
                ...
                if __class__.bitAddr == __class__.searchKey or __class__.bitAddr_C == __class__.searchKey:
                    self.wfile.write(bytes("<span style='color:#DE3163;display:inline-block;width:450px;font-weight:bold;' class='show_popup' rel='popup1' num='"+str(i+1)+"' value='"+__class__.starting_key_hex+"'>"+__class__.starting_key_hex+"</span><span style='display:inline-block;width:360px;color:#DE3163;'>" + __class__.privKey + "</span><span style='display:inline-block;width:242px;color:#145A32;'><a target='_blank' href='https://bitaps.com/" + __class__.bitAddr + "'>" + __class__.bitAddr + "</a></span>" + "<span style='display:inline-block;width:242px;color:#D35400;'><a target='_blank' href='https://bitaps.com/" + __class__.bitAddr_C + "'>" + __class__.bitAddr_C + "</a></span><span style='display:inline-block;width:244px;color:#D35400;'><a target='_blank' href='https://bitaps.com/"+addrP2sh+"'>"+addrP2sh+"</a></span><span style='display:inline-block;width:298px;color:#D35400;'><a target='_blank' href='https://bitaps.com/"+addrbech32+"'>"+addrbech32+"</a></span><span style='display:inline-block;width:436px;color:#D35400;'><a target='_blank' href='https://bitaps.com/"+addrbech32_p2wsh+"'>"+addrbech32_p2wsh+"</a></span><span style='display:inline-block;width:368px;color:#DE3163'>" + __class__.privKey_C + "</span>" +"</br>", "utf-8"))
                    __class__.searchKey = ""
                    ...
                    self.wfile.write(bytes("<span style='color:#DE3163;display:inline-block;width:450px;font-weight:bold;' class='show_popup' rel='popup1' num='"+str(i+1)+"' value='"+__class__.starting_key_hex+"'>"+__class__.starting_key_hex+"</span><span style='display:inline-block;width:360px;color:#145A32;'>" + __class__.privKey + "</span><span style='display:inline-block;width:242px;color:#145A32;'><a target='_blank' href='https://bitaps.com/" + __class__.bitAddr + "'>" + __class__.bitAddr + "</a></span>" + "<span style='display:inline-block;width:242px;color:#D35400;'><a target='_blank' href='https://bitaps.com/" + __class__.bitAddr_C + "'>" + __class__.bitAddr_C + "</a></span><span style='display:inline-block;width:244px;color:#D35400;'><a target='_blank' href='https://bitaps.com/"+addrP2sh+"'>"+addrP2sh+"</a></span><span style='display:inline-block;width:298px;color:#D35400;'><a target='_blank' href='https://bitaps.com/"+addrbech32+"'>"+addrbech32+"</a></span><span style='display:inline-block;width:436px;color:#D35400;'><a target='_blank' href='https://bitaps.com/"+addrbech32_p2wsh+"'>"+addrbech32_p2wsh+"</a></span><span style='display:inline-block;width:368px;color:#145A32;'>" + __class__.privKey_C + "</span>" +"</br>", "utf-8"))
                else:
                    self.wfile.write(bytes("<span style='color:#DE3163;display:inline-block;width:450px;' class='show_popup' rel='popup1' num='"+str(i+1)+"' value='"+__class__.starting_key_hex+"'>"+__class__.starting_key_hex+"</span><span style='display:inline-block;width:360px;color:#145A32;'>" + __class__.privKey + "</span><span style='display:inline-block;width:242px;color:#145A32;'><a target='_blank' href='https://bitaps.com/" + __class__.bitAddr + "'>" + __class__.bitAddr + "</a></span>" + "<span style='display:inline-block;width:242px;color:#D35400;'><a target='_blank' href='https://bitaps.com/" + __class__.bitAddr_C + "'>" + __class__.bitAddr_C + "</a></span><span style='display:inline-block;width:244px;color:#D35400;'><a target='_blank' href='https://bitaps.com/"+addrP2sh+"'>"+addrP2sh+"</a></span><span style='display:inline-block;width:298px;color:#D35400;'><a target='_blank' href='https://bitaps.com/"+addrbech32+"'>"+addrbech32+"</a></span><span style='display:inline-block;width:436px;color:#D35400;'><a target='_blank' href='https://bitaps.com/"+addrbech32_p2wsh+"'>"+addrbech32_p2wsh+"</a></span><span style='display:inline-block;width:368px;color:#145A32;'>" + __class__.privKey_C + "</span>" +"</br>", "utf-8"))
            ...
            #self.wfile.write(bytes("<script>alert('Bullshit');</script>", "utf-8"))
            self.wfile.write(bytes("""
<script>                       
...
$('#arrow_right').click(function() {
    ...
    if(item_num != last) { 
        ...
        $('#arrow_num').html(last); 
            ...
            __class__.addresses.clear() #clearing generated addresses list so we can use it fresh with next page request #dropping values to defaults            
...
<p id='same2addrpb' style='color:blue;background:#D7DBDD;padding:3px;font-weight:bold;font-size: 12px;'></p>
            ...
            for i in range(128): #generating addresses and WIFS to show on page
                ...
                addrP2sh = ice.privatekey_to_address(1, True, dec) #p2sh
                addrbech32 = ice.privatekey_to_address(2, True, dec) #bech32
                addrbech32_p2wsh = bitcoinlib.keys.Address(ice.point_to_cpub(ice.point_multiplication(__class__.startPrivKey,G)),encoding='bech32',script_type='p2wsh').address #bech32_p2swh
                #addrETH = ice.privatekey_to_ETH_address(__class__.startPrivKey)                
                __class__.addresses.append(__class__.bitAddr)
                __class__.addresses.append(__class__.bitAddr_C)
                __class__.addresses.append(addrP2sh)
            ...
            if __class__.balance_on_page == "True":
                ...
                mixer.music.load("success.mp3")
                mixer.music.play()
            #self.wfile.write(bytes("<audio autoplay><source src='success.mp3' type='audio/mpeg'></audio>", "utf-8"))
            #-------------------------------------------------------------------------------
            self.wfile.write(bytes("</pre><pre class='keys'>[&nbsp;<span style='color:blue;' class='ajax' page='/"+str(__class__.previous)+"'>previous</span> | ", "utf-8"))
            self.wfile.write(bytes("<span style='color:blue;' class='ajax' page='/"+str(__class__.next)+"'>next</span> | ", "utf-8"))
            self.wfile.write(bytes("<span style='color:blue;' class='ajax' page='/"+str(__class__.random)+"'>random</span>&nbsp;]", "utf-8"))
